...
_0x0:
	.DB  0x0,0x57,0x65,0x20,0x61,0x72,0x65,0x20
	.DB  0x69,0x6E,0x20,0x49,0x6E,0x74,0x20,0x30
	.DB  0x20,0x46,0x75,0x6E,0x63,0x74,0x69,0x6F
	.DB  0x6E,0x0,0x50,0x49,0x4E,0x43,0x20,0x77
	.DB  0x61,0x73,0x20,0x54,0x72,0x75,0x65,0x0
	.DB  0x50,0x49,0x4E,0x43,0x20,0x77,0x61,0x73
	.DB  0x20,0x46,0x61,0x6C,0x73,0x65,0x0
_0x2040003:
	.DB  0x80,0xC0
...
; 0000 0027     lcd_clear();
	CALL _lcd_clear
; 0000 0028     lcd_puts("We are in Int 0 Function");
	__POINTW2MN _0x4,0
	CALL _lcd_puts
; 0000 0029     PORTC.0 = 1 ;
	SBI  0x15,0
...
; 0000 007F 
; 0000 0080 
; 0000 0081 GICR|=(0<<INT1) | (1<<INT0) | (1<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0x60)
	OUT  0x3B,R30
; 0000 0082 MCUCR=(0<<ISC11) | (0<<ISC10) | (1<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(3)
	OUT  0x35,R30
; 0000 0083 MCUCSR=(1<<ISC2);
	LDI  R30,LOW(64)
	OUT  0x34,R30
; 0000 0084 GIFR=(0<<INTF1) | (1<<INTF0) | (1<<INTF2);
	LDI  R30,LOW(96)
	OUT  0x3A,R30
; 0000 0085 
...
; 0000 00B2       /*
; 0000 00B3       lcd_puts("Hello World !");
; 0000 00B4       delay_ms(1000);
; 0000 00B5       lcd_clear();
; 0000 00B6       lcd_puts("Bye Bye");
...
; 0000 00BB       delay_ms(1000);
	...
	LDI  R27,HIGH(1000)
	CALL _delay_ms
; 0000 00BC       if ( PINC.3 == 1 ){
	SBIS 0x13,3
	RJMP _0xC
; 0000 00BD         sprintf(mySentence , "PINC was True" );
	ST   -Y,R5
	ST   -Y,R4
	__POINTW1FN _0x0,26
	RJMP _0x10
; 0000 00BE       }
; 0000 00BF 
; 0000 00C0       else if( PINC.3 == 0 ){
_0xC:
	SBIC 0x13,3
	RJMP _0xE
; 0000 00C1          sprintf(mySentence , "PINC was False" );
	ST   -Y,R5
	ST   -Y,R4
	__POINTW1FN _0x0,40
_0x10:
